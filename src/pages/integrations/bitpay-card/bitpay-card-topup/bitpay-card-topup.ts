...
export class BitPayCardTopUpPage {
        ...
        this.getSendMaxInfo(wallet)
          .then(maxValues => {
            ...
            this.createInvoice({
              ...
              .then(inv => {
                // Check if ACM or BCH is enabled in this account
  ...
  public openExternalLink(urlKey: string) {
    ...
    switch (urlKey) {
      ...
      case 'minerFee':
        url =
          'https://support.bitpay.com/hc/en-us/articles/115003393863-What-are-actinium-miner-fees-Why-are-miner-fees-so-high-';
